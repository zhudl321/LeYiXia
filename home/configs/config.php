		...
		'URL_ROUTE_RULES' => array( //定义路由规则
    		   ...
    		   // ':name/page/:p\d'         =>'Index/index',
    		    ...
    		    'new'                        =>array('Index/index','type=new'), 
                        ...
                        'daily/page/:p\d'              =>array('Index/index','type=daily'),
                        'daily'                        =>array('Index/index','type=daily'), 
                        'duanzi/page/:p\d'              =>array('Index/index','type=duanzi'),
                        'duanzi'                        =>array('Index/index','type=duanzi'), 
                        'shenhuifu/page/:p\d'              =>array('Index/index','type=shenhuifu'),
                        'shenhuifu'                        =>array('Index/index','type=shenhuifu'),                    
                        'random'                        =>array('Index/index','type=random'), 
                        'about/:type'               =>'About/index',
                        'pull/:tag\d/:p\d'               =>'Pull/index',
                        'baidu'               =>'Pull/baidu',
